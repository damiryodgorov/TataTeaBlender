      ...
      //winStart = this.state.prec['WindowStart'];
        ...
        <Modal  x={true} ref={this.batModal} Style={{maxWidth:1200, width:'95%'}} innerStyle={{background:backgroundColor, maxHeight:650}}>
         <BatchControl selfProd={this.state.srec['EditProdNo']} prod={this.state.prec} startB={this.start} mac={this.state.curDet.mac} stopB={this.stop} 
                   ...
                   <div style={{display:'inline-block', verticalAlign:'top'}}> <BatchBarGraph crec={this.state.crec} language={language}/></div><div style={{display:'inline-block'}}><StatSummary  language={language} branding={this.state.branding} /></div>
                    </BatchControl>
        </Modal>
...
class BatchControl extends React.Component{
  ...
  render(){
    ...
    var pl = 'assets/play-arrow-fti.svg'
      ...
      var batchList = <div style={{width:300, background:'#e1e1e1', border:'2px solid #e1e1e1', height:515, margin:5, marginBottom:0}}>
       <div> <div style={{borderBottom:'2px solid #ccc', lineHeight:'60px', height:60, textAlign:'center'}}>Current Batch</div>
        ...
        <div style={{height:326}}><div style={{borderBottom:'2px solid #ccc', lineHeight:'60px', height:60, textAlign:'center'}}>Planned Batches</div></div>
                <div style={{height:66,lineHeight:'66px', background:'#e1e1e1', borderTop:'1px solid #ccc'}}>
          <div onClick={this.copyTo} style={{display:'table-cell',height:66, borderRight:'2px solid #ccc', width:150, fontSize:15, lineHeight:'20px', verticalAlign:'middle', textAlign:'center'}}>+ Add New Batch</div>
