	...
	render(){
		...
		/*	data[lvl - 1 ][0].subCats.forEach(function(sc,i){
			...
			//		//console.log("Is this the problem")
				...
				var	acc = false;
				////console.log(p)
					if(( p.acc.indexOf(0) != -1)||(self.props.level > 2) || (p.acc.indexOf(self.props.level) != -1)){
						acc = true;
					}
				//	//console.log(['2063',d])
			//		self.props.level accLevel
					...
					if(( par.acc.indexOf(0) != -1)||(self.props.level > 2) || (par.acc.indexOf(self.props.level) != -1)){
						acc = true;
					}
...
class DetectorView extends React.Component{
	...
	showSettings () {
		if((vdefByMac[this.props.det.mac][4][0].acc.indexOf(0) != -1) || (vdefByMac[this.props.det.mac][4][0].acc.indexOf(this.state.level) != -1)||(this.state.level > 2)){
	...
	showSens () {
		if((vdefByMac[this.props.det.mac][7]['SensEdit'].indexOf(0) != -1) || (vdefByMac[this.props.det.mac][7]['SensEdit'].indexOf(this.state.level) != -1)||(this.state.level > 2)){
	...
	showTestModal () {
		if((vdefByMac[this.props.det.mac][7]['TestButton'].indexOf(0) != -1) || (vdefByMac[this.props.det.mac][7]['TestButton'].indexOf(this.state.level) != -1)||(this.state.level > 2)){
	...
	toggleTestSettings () {
		if((vdefByMac[this.props.det.mac][6]['Test'].acc.indexOf(0) != -1) || (vdefByMac[this.props.det.mac][6]['Test'].acc.indexOf(this.state.level) != -1)||(this.state.level > 2)){
	...
	toggleCalSettings () {
		if((vdefByMac[this.props.det.mac][6]['Calibration'].acc.indexOf(0) != -1) || (vdefByMac[this.props.det.mac][6]['Calibration'].acc.indexOf(this.state.level) != -1)||(this.state.level > 2)){
	...
	toggleSensSettings () {
		if((vdefByMac[this.props.det.mac][6]['Sens'].acc.indexOf(0) != -1) || (vdefByMac[this.props.det.mac][6]['Sens'].acc.indexOf(this.state.level) != -1)||(this.state.level > 2)){
	...
	showCalibModal () {
		if((vdefByMac[this.props.det.mac][7]['Calib'].indexOf(0) != -1) || (vdefByMac[this.props.det.mac][7]['Calib'].indexOf(this.state.level) != -1)||(this.state.level > 2)){
		...
		return(<div>
			...
			<Modal ref='sModal' onClose={this.settingsClosed} intMeter={true} clear={this.clearSig}>
				...
				<Modal ref='loginModal' intMeter={true} clear={this.clearSig}>
					<LogInControl  mac={this.props.det.mac} ip={this.props.ip} accounts={this.state.usernames} authenticate={this.authenticate} language={'english'} login={this.login} val={this.state.userid}/>
				</Modal>
...
class AccountControl extends React.Component{
	...
	render(){
		...
		var accTableRows = [];
		this.props.accounts.forEach(function(ac){
			accTableRows.push(<AccountRow username={ac.username} acc={ac.acc} password={'*******'} saved={true} ip={self.props.ip}/>)
		})
...
class InterceptorMainPageUI extends React.Component{
	...
	showEditor () {
		//7025
		if((vdefByMac[this.props.det.mac][7]['ProductButton'].indexOf(0) != -1) || (vdefByMac[this.props.det.mac][7]['ProductButton'].indexOf(this.props.level) != -1)||(this.props.level > 2)){
	...
	changeProdEditMode () {
		if((vdefByMac[this.props.det.mac][7]['ProductEdit'].indexOf(0) != -1) || (vdefByMac[this.props.det.mac][7]['ProductEdit'].indexOf(this.props.level) != -1)||(this.props.level > 2)){
...
class InterceptorDynamicViewV2 extends React.Component{
	...
	render () {
		...
		var sensacc = 	(vdefByMac[this.props.mac][7]['SensEdit'].indexOf(0) != -1) || (vdefByMac[this.props.mac][7]['SensEdit'].indexOf(this.props.level) != -1)||(this.props.level > 2)
