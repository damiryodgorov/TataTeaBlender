		...
		*/
		...
		return (<div className='interceptorMainPageUI' style={style}>
					<table className='landingMenuTable' style={{marginBottom:-4, marginTop:-7}}>
						<tbody>
							<tr>
								<td style={{width:438}}><img style={lstyle}  src='assets/Interceptor-white-01.svg'/>{dfLab}</td><td><IntClock dst={this.state.sysRec['DaylightSavings']} sendPacket={this.sendPacket} language={lg} ref='clock'/></td>
							{logintext}	{logincell}
				<td className="buttCell" style={{height:60}}><button onClick={this.gohome} className={home}/></td>
							</tr>
						</tbody>
