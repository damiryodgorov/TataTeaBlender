	...
	renderLanding() {
		...
		return (<div className = 'landingPage'>
					...
					<Modal ref='dispModal' innerStyle={{background:'#e1e1e1'}}>
						<DispSettings nif={this.state.nifip} nm={this.state.nifnm} gw={this.state.nifgw}/>
					</Modal>
					<Modal ref='logModal'>
...
var CustomKeyboardCont = onClickOutside(createReactClass({
	...
	render:function () {
		...
		<div style={{color:'#a0a0a0',fontSize:25,marginRight:'auto',marginLeft:'auto',display:'block'}}>
			{label}</div>{helpButton}
