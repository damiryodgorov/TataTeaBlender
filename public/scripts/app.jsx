...
class LandingPage extends React.Component{
	constructor(props) {
		...
		this.state =  ({currentPage:'landing',netpolls:{}, curIndex:0, minMq:minMq, minW:minMq.matches, mq:mq, brPoint:mq.matches, 
			...
			detL:{}, macList:[], tmpMB:{name:'NEW', type:'mb', banks:[]}, accounts:['operator','engineer','Fortress'],usernames:['ADMIN','','','','','','','','',''], nifip:'', nifnm:''})
	...
	renderLanding() {
		...
		return (<div className = 'landingPage'>
					...
					<Modal ref='dispModal' innerStyle={{background:'#e1e1e1'}}>
						<DispSettings nif={this.state.nifip} nm={this.state.nifnm}/>
					</Modal>
					<Modal ref='logModal'>
	...
	renderDetector() {
		...
		return (<DetectorView nifip={this.state.nifip} nifnm={this.state.nifnm} br={this.state.brPoint} ref='dv' acc={this.state.level} accounts={this.state.accounts} logoClick={this.logoClick} det={this.state.curDet} ip={this.state.curDet.ip} mac={this.state.curDet.mac} netpolls={this.state.netpolls[this.state.curDet.ip]}/>)
...
class DispSettings extends React.Component{
	...
	<div style={{display:'inline-block', textAlign:'center'}}>Display Settings</div></h2></span>
			...
			<CustomKeyboard pwd={false} vMap={this.props.vMap}  onFocus={this.onFocus} ref={'nm'} onRequestClose={this.onRequestClose} onChange={this.onChangeNM} index={0} value={this.props.nif} num={true} label={'Address'}/>
...
class InterceptorMainPageUI extends React.Component{
	...
	render () {
		...
		return (<div className='interceptorMainPageUI' style={style}>
			...
			<InterceptorDynamicViewV2 mac={this.props.mac} testReq={this.props.testReq}  language={lg} onButton={this.onButton} onSens={this.onSens} rejOn={this.props.rejOn} faultArray={this.props.faultArray} ref='dv' sys={this.state.sysRec} sens={[this.state.prodRec['Sens_A'],this.state.prodRec['Sens_B']]} sig={[this.state.peak,this.state.peakb]} pleds={[this.state.pled_a,this.state.pled_b]} rej={this.state.rej} onKeyboardOpen={this.keyboardOpen} onKeyboardClose={this.keyboardClose} level={this.props.level}/>
			<InterceptorNav testReq={this.props.testReq} isUpdating={this.props.isUpdating}  status={this.props.status} language={lg} onButton={this.onButton} ref='nv' clearFaults={this.props.clearFaults} rejOn={this.props.rejOn}  faultArray={this.props.faultArray} prodName={this.state.prodRec['ProdName']} />
				<Modal ref='testModal'>
					<TestReq ip={this.props.det.ip} toggle={this.toggleTestModal}/>
				</Modal>
...
class InterceptorNav extends React.Component{
	...
	//	////console.log([vdefMapV2['@labels']['Settings'],this.props.language])
		return (<div className='interceptorNav' style={{display:'block', width:950, marginLeft:'auto',marginRight:'auto', background:'black'}}>
				...
				<InterceptorNavContent isUpdating={this.props.isUpdating} status={this.props.status} testReq={this.props.testReq} toggleTest={this.onTestReq} rejOn={this.props.rejOn} language={this.props.language} ref='nv' clearFaults={this.props.clearFaults} faultArray={this.props.faultArray} prodName={this.props.prodName}><SlimGraph int={true} ref='sg' canvasId={'sgcanvas2'}/>	</InterceptorNavContent>
				</div></td><td>
				<div className='slantedLeft'><div style={{background:'#362c66', borderTopLeftRadius:'30px 40px', height:240, textAlign:'center'}}>
