...
class DetectorView extends React.Component{
	constructor(props) {
		...
		this.state =  {callback:null, rec:{},	showTest:false, faultArray:[],pind:0,currentView:'MainDisplay', data:[], stack:[], pn:'', sens:0, netpoll:this.props.netpolls, 
			prodSettings:{}, sysSettings:{}, combinedSettings:[],cob2:[], pages:{}, showCal:false,userid:0,
			minMq:minMq, minW:minMq.matches, br:this.props.br, mqls:mqls, fault:false, usb:false, usernames:['ADMIN','','','','','','','','',''],
	...
	toggleCalSettings () {
		// accessControl
		if((vdefByMac[this.props.det.mac][6]['Calibration'].acc <= this.state.level)||(this.state.level > 2)||(this.state.sysSettings['PassOn'] == 0)){
	...
	toggleSensSettings () {
		// accessControl
		if((vdefByMac[this.props.det.mac][6]['Sens'].acc <= this.state.level)||(this.state.level > 2)||(this.state.sysSettings['PassOn'] == 0)){
...
class InterceptorMainPageUI extends React.Component{
	...
	changeProdEditMode () {
		// accessControl
		if((vdefByMac[this.props.det.mac][7]['ProductEdit'] <= this.props.level)||(this.props.level > 2)){
