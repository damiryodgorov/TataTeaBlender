...
class DispSettings extends React.Component{
	...
	<div style={{display:'inline-block', textAlign:'center'}}>Display Settings</div></h2></span>
			...
			<div style={vlabelswrapperStyle}><div style={vlabelStyle}><label style={_st}>{this.props.nif}</label></div></div>
			 ...
			 <div className='sItem noChild' onClick={this.onClickNM}><label style={{display: 'table-cell',fontSize: 24,width: '310',background: '#5d5480',borderTopLeftRadius: 20,borderBottomLeftRadius: 20,textAlign: 'center', color: '#eee'}}>{'Display Netmask'}</label>
			<div style={vlabelswrapperStyle}><div style={vlabelStyle}><label style={_st}>{this.props.nm}</label></div></div>
			</div>
			 <div className='sItem noChild' onClick={this.onClickGW}><label style={{display: 'table-cell',fontSize: 24,width: '310',background: '#5d5480',borderTopLeftRadius: 20,borderBottomLeftRadius: 20,textAlign: 'center', color: '#eee'}}>{'Display Gateway'}</label>
