	...
	valChanged(v){
		...
		if(this.props.pass6 == 0){
			if(v.length == 6){
				...
				notify.show('Password should be 6 characters')
			}
		}else{
			if(v.length == 4){
				this.props.authenticate(this.state.val,v)
			}else{
				notify.show('Password should be 4 characters')
			}
		}
	...
	render () {
		...
		*/
		...
		return (<div className='interceptorMainPageUI' style={style}>
			...
			<InterceptorNav ref='nc' testReq={this.props.testReq} isUpdating={this.props.isUpdating} clearRejLatch={this.clearRejLatch}  status={this.props.status} language={lg} onButton={this.onButton} ref='nv' clearFaults={this.props.clearFaults} clearWarnings={this.props.clearWarnings} rejOn={this.props.rejOn} rejLatch={this.props.rejLatch}  faultArray={this.props.faultArray} warningArray={this.props.warningArray} prodName={this.state.prodRec['ProdName']} />
				<Modal ref='testModal'>
					<TestReq ip={this.props.det.ip} toggle={this.toggleTestModal}/>
				</Modal>
...
class InterceptorNav extends React.Component{
	...
	render () {
		...
		return (<div className='interceptorNav' style={{display:'block', width:950, marginLeft:'auto',marginRight:'auto', background:'black'}}>
				...
				<InterceptorNavContent isUpdating={this.props.isUpdating} status={this.props.status} clearWarnings={this.props.clearWarnings} clearRejLatch={this.clearRejLatch} testReq={this.props.testReq} 
				...
				<SlimGraph int={true} ref='sg' canvasId={'sgcanvas2'}/>	</InterceptorNavContent>
				</div></td><td>
				<div className='slantedLeft'><div style={{background:'#362c66', borderTopLeftRadius:'30px 40px', height:240, textAlign:'center'}}>
