...
class DetectorView extends React.Component{
	...
	//	////console.log(lg)
		...
		if(vdefByMac[this.props.det.mac][0]['@defines']['INTERCEPTOR_DF']){
			df = true;
			sensui =  <InterceptorDFSensitivityUI ref='dfs'  mac={this.props.det.mac} language={lg} level={this.state.level} sigmode={this.state.prodSettings['SigModeDF']} onSigMode={this.sendPacket} sens={this.state.prodSettings['Sens']} sensA={this.state.prodSettings['Sens_A']} sensB={this.state.prodSettings['Sens_B']} onFocus={this.onSensFocus} onRequestClose={this.onSensClose} sendPacket={this.sendPacket} refresh={this.refresh} onSens={this.onSens}/>
...
class InterceptorNav extends React.Component{
	...
	render () {
		...
		return (<div className='interceptorNav' style={{display:'block', width:987, marginLeft:'auto',marginRight:'auto', background:'linear-gradient(90deg, transparent, transparent 5%, black 5%, black 95%, transparent 95%)'}}>
				...
				<CircularButton fSize={35} style={right} lab={vdefMapV2['@labels']['Calibrate'][this.props.language]['name']} inverted={true} onClick={this.onCal}/>
			...
			<tbody>
				<tr>
					<td style={{width:340, background:'#818a90', textAlign:'center'}}>
						...
						<div hidden={1==this.props.learnComb} style={{marginBottom:15}}><CircularButton style={{width:228}} lab={vdefMapV2['@labels']['Calibrate'][this.props.language]['name']} isTransparent={true} inverted={false} onClick={this.onCalA}/></div>
					</td>
					<td  style={{width:220,textAlign:'center', background:'linear-gradient(55deg, #818a90, #818a90 49.9%,#362c66 50.1%, #362c66)'}}>
					<div hidden={1!=this.props.learnComb}>
					<CircularButton lab={vdefMapV2['@labels']['Calibrate All'][this.props.language]['name']} isTransparent={true} inverted={false} onClick={this.calibrateAll} />
					</div>
						...
						<div hidden={1==this.props.learnComb} style={{marginBottom:15}}><CircularButton style={{width:228}} lab={vdefMapV2['@labels']['Calibrate'][this.props.language]['name']} isTransparent={true} inverted={true} onClick={this.onCalB}/></div>
					</td>
				</tr>
			</tbody>
		</table>
