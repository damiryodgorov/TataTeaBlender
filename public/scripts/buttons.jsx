...
class CircularButton2 extends React.Component{
	constructor(props) {
...
export {ButtonWrapper, CircularButton, CircularButton2, CustomAlertButton, CustomAlertClassedButton}
/*
module.exports = {}
